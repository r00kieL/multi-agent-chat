...
function DepthToggle({ depth, onDepthChange, disabled, className = '' }) {
  return (
    <div className={`flex items-center gap-1 p-0.5 rounded-lg bg-black/20 ${className}`}>
...
export default function InputPanel({
  ...
  const resolvedPlaceholder = placeholder ?? PLACEHOLDERS[mode] ?? PLACEHOLDERS.chat
            ...
            <div className="hidden sm:flex items-center gap-2">
              ...
              <div className="mode-depth-panel" data-open={isDiscussion}>
                <div className="mode-depth-inner">
                  <DepthToggle depth={depth} onDepthChange={onDepthChange} disabled={disabled} />
                </div>
              </div>
            </div>
          </div>
